package attender.oparkReceipt.parkinglist;
...
import attender.oparkReceipt.parkinglist.adapter.ParkingAdapter;
...
//                Toast.makeText(CarInActivity.this, vehicleModelList.get(position).getTransactionId(), Toast.LENGTH_SHORT).show();
    ...
    private void showGateType(final String gateId) {
        LayoutInflater inflater = getLayoutInflater();
        View alertLayout = inflater.inflate(R.layout.layout_custom_dialog_gate, null);
       ...
       // final RadioGroup radio = (RadioGroup) alertLayout.findViewById(R.id.radio);
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                if (checkedId == R.id.Gate1) {
                   ...
                   // showGateType(GateId);
                    ...
                    Toast.makeText(ParkingList.this, "Please Select Gate No", Toast.LENGTH_SHORT).show();
                }
            }
        });*/
        radioGate.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Log.e(TAG, "onClick:btnSubmit "+gateId);
                if (sharedpref.getString("VehicleType1", "").equals("")) {
                    Toast.makeText(ParkingList.this, "Please select Vehicle type", Toast.LENGTH_SHORT).show();
                } else if (sharedpref.getString("GateId", "").equals("")) {
                    Toast.makeText(ParkingList.this, "Please select Gate ", Toast.LENGTH_SHORT).show();
                    ...
                    public void onCheckedChanged(RadioGroup group, int checkedId) {
                        ...
                        if (checkedId == R.id.twowheeler) {
                           ...
                           // showGateType(GateId);
                            ...
                            String VehicleType1 = sharedpref.getString("VehicleType1", "");
                            String getParkingID = sharedpref.getString("getParkingID", "");
                            String GateId = sharedpref.getString("GateId", "");revenewSevice(getParkingID, agentId, VehicleType1, GateId);
                           // showGateType(GateId);
