...
/**
 * Created by Daffodil on 7/4/2018.
 */

public class SubscriptionModel {

    String cardNo,parkingName,agentName,agentId,vehicleNo,plan,total,holderName,passHeading,renewableDate,receiptHeading,parkingAddress,companyWebsite,poweredBy , passNumber,address,mobileNo,cardHolderName;
