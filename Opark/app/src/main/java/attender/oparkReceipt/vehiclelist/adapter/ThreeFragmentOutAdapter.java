...
public class ThreeFragmentOutAdapter extends RecyclerView.Adapter<ThreeFragmentOutAdapter.ViewHolder>{
        private Context context;
    ThreeWheelerFragmentOut fourFragmentOut;
        private ArrayList<VehicleModelDetails> vehicleModelList = new ArrayList<>();

        public ThreeFragmentOutAdapter(ThreeWheelerFragmentOut fourFragmentOut, ArrayList<VehicleModelDetails> vehicleModelList) {
            this.fourFragmentOut = fourFragmentOut;
            this.vehicleModelList = vehicleModelList;
            context = fourFragmentOut.getContext();
        }
        @Override
        public ThreeFragmentOutAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(context).inflate(R.layout.layout_view_mange_vehicle, parent, false);
            return new ThreeFragmentOutAdapter.ViewHolder(view);
        }


        @Override
        public void onBindViewHolder(ThreeFragmentOutAdapter.ViewHolder holder, int position) {
