...
import attender.oparkReceipt.vehiclelist.adapter.FourWheelerAdapter;

public class FourWheelerList extends AppCompatActivity {
    ...
    FourWheelerAdapter twoWheelerListAdapter;
    ...
    private void init() {
        ...
        final TypedArray styledAttributes = FourWheelerList.this.getTheme().obtainStyledAttributes(
                new int[]{android.R.attr.actionBarSize}
        );
        normalWindowHeight = DimensionUtil.getScreenHeight(FourWheelerList.this);
...
//        relativeLayoutHeader.setLayoutParams(params);
        ...
        textToolHeader.setText("Four Wheeler List");
        setSupportActionBar(toolBar);
    ...
    private void loadViewPager(ViewPager viewPager) {
        twoWheelerListAdapter = new FourWheelerAdapter(getSupportFragmentManager(),
                FourWheelerList.this,"4wheeler");
