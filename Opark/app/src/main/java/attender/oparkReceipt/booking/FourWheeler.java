...
public class FourWheeler extends AppCompatActivity implements View.OnClickListener {
    private static final String TAG = "FourWheeler";
    ...
    String agentId = "", userRole = "", getParkingID,getParkingName,userName = "", userContactNo = "", vendorId = "", vendorName = "", parkingName = "", parkingType = "", parkingId = "", pType2 = "", pType4 = "", parkingVehicle = "", subVehicleNo = "", userTypeData,userType = "", barCode = "";
       ...
       /* toolBar = (Toolbar) findViewById(R.id.toolBar);
        ...
        toolBar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent1 = new Intent(FourWheeler.this, MainActivity.class);
        ...
        etMobileNo.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                if (etMobileNo.getText().toString().length() == 10)     //size as per your requirement
                {
                    ...
                    AppConstants.hideKeyboard(FourWheeler.this, etMobileNo);
                }
            }
        ...
        otp_VehicleNumber.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                if (otp_VehicleNumber.getText().toString().length() == 4)     //size as per your requirement
                {
                    ...
                    AppConstants.hideKeyboard(FourWheeler.this, otp_VehicleNumber);
                }
        ...
        vipVehicleNumber.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                if (vipVehicleNumber.getText().toString().length() == 10)     //size as per your requirement
                {
                    ...
                    AppConstants.hideKeyboard(FourWheeler.this, vipVehicleNumber);
                }
            }
...
//                    btnScanQRCode.setVisibility(View.VISIBLE);
    ...
    public void onClick(View v) {
        ...
        AppConstants.hideKeyboard(FourWheeler.this, v);

        if (v == btnCheckIn) {
            validate();
        } else if (v == btnCheckout) {
            validate1();
        } else if (ContextCompat.checkSelfPermission(FourWheeler.this, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
    ...
    private void moveToQrScan() {
        try {
            Intent qrintent = new Intent(FourWheeler.this, QRScanPrint.class);
        ...
        if (userType.equals("VIP")) {
            if (AppConstants.isBlank(vipvehicleNumber)) {
                if (!etvipInfo.getText().toString().equals("")) {
                    ...
                    Toast.makeText(FourWheeler.this, "Enter VIP Info", Toast.LENGTH_SHORT).show();
                }
            ...
            if (userType.equals("Online")) {
                if (AppConstants.isBlank(otp_VehicleNumber.getText().toString())) {
                    ...
                    Toast.makeText(FourWheeler.this, "Enter OTP required", Toast.LENGTH_SHORT).show();
                } else if (tagID.equals("")) {
                    Toast.makeText(this, "Please Scan card!", Toast.LENGTH_SHORT).show();
    ...
    public void checkin() {
        if (AppConstants.isBlank(vehicleNumber)) {
            ...
            AppConstants.showToast(FourWheeler.this, "Vehicle number should be 4 digit");
            etVehicleNumber.requestFocus();
        } else {
...
//                Toast.makeText(FourWheeler.this, "Enter Vehicle number required", Toast.LENGTH_SHORT).show();
    ...
    private void apiCall() {
        ...
        if (AppConstants.isInternetAvailable(FourWheeler.this)) {
            ...
            if (pType.length == 2) {
                ...
                parameterData.put(("parkingType"), "4Wheeler");
            ...
            Toast.makeText(FourWheeler.this, "Internet Connection Required", Toast.LENGTH_LONG).show();
        }
    }
    ...
    public void vehicleCheckInServices(String url, final Map<String, String> params) {
        ...
        final ProgressDialog pDialog = new ProgressDialog(FourWheeler.this);
            ...
            Response.ErrorListener errorListener = new Response.ErrorListener() {
                ...
                public void onErrorResponse(VolleyError volleyError) {
                    ...
                    if (volleyError instanceof NetworkError) {
                        ...
                        Toast.makeText(FourWheeler.this,
                                "Oops. Network Error !",
            ...
            try {
                ...
                if (status == 0) {
                    ...
                    if (cardNo.equals("")) {
                        ...
                        tagID = "";
                        if (pType.length == 2) {
                            availableSlotSevice(parkingId, "4Wheeler", agentId);
                        } else {
                            availableSlotSevice(parkingId, "4Wheeler", agentId);
                        }
                ...
                Toast.makeText(FourWheeler.this, "Unexpected Error...", Toast.LENGTH_SHORT).show();
                e.printStackTrace();
                // pDialog.dismiss();
            } catch (JSONException e) {
                e.printStackTrace();
                sendError(e.toString(), "parking/checkin?parkingId=");
                Toast.makeText(FourWheeler.this, "Technical Error...", Toast.LENGTH_SHORT).show();
                // pDialog.dismiss();
            }
        }
    }
    ...
    private void apiCallCheckOut() {
        ...
        if (AppConstants.isInternetAvailable(FourWheeler.this)) {
            // String vehicleNo = StateCode + CityCode + VehicleCode + vehicleNumber;
            if (pType.length == 2) {
                vehicleCheckOut(parkingId, "4Wheeler", vehicleNo, agentId, userType, mobileNumber, tagID, vipinfo);
            } else {
                vehicleCheckOut(parkingId, "4Wheeler", vehicleNo, agentId, userType, mobileNumber, tagID, vipinfo);
            }
    ...
    private void showAlert(String message) {
        AppConstants.showToast(FourWheeler.this, message);
    }
...
*/
    ...
    public void vehicleCheckOut(final String parkingId, String parkingType, String vehicleNo, final String agentId, String mode, String userdata, String cardNo, String vipinfo) {
        ...
        String urlData = AppConstants.BASEURL + "parking/checkout?parkingId=" + parkingId + "&parkingType=" + "4Wheeler" + "&vehicleNo=" + vehicleNo + "&agentId="
                + agentId + "&mode=" + mode + "&userdata=" + userdata + "&cardNo=" + cardNo + "&vipInfo=" + vipinfo;
    ...
    private void printReceipt() {
        if (printer == null) {
            Toast.makeText(FourWheeler.this, "No Printer found", Toast.LENGTH_SHORT).show();
            return;
        }
...
//                        showResultInfo("Print Exception", "Error", message);
        ...
        try {
            ...
            printNormal(FourWheeler.this, printer);
...
//        if (printError.equals("yes")) {
    ...
    public void id(Intent intent) {
        ...
        AppConstants.setString(FourWheeler.this, AppConstants.TAGID, tagID);
...
//cardNo=CARD578&parkingId=30&parkingType=2Wheeler
        String urlData = AppConstants.BASEURL + "parking/pass_detail_checkout?cardNo=" + tagID+"&parkingId="+parkingId+"&parkingType=4Wheeler";
...
*/
                        ...
                        if (message1.equals("Card Not Exist !")) {
                            ...
                            Toast.makeText(FourWheeler.this, message1, Toast.LENGTH_SHORT).show();
...
*/
    ...
    private void checkPermissions() {
        if (ContextCompat.checkSelfPermission(this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            ...
            startActivity(new Intent(FourWheeler.this, MainActivity.class));
        }
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            case R.id.Paytm:
                ...
                Intent intent = new Intent(FourWheeler.this, TransationActivity.class);
