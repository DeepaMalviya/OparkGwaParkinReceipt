...
public class
TwoWheeler extends AppCompatActivity implements View.OnClickListener {
    private static final String TAG = "TwoWheeler";
    ...
    String agentId, userRole, userName, getParkingName, userContactNo, vendorId, vendorName, parkingName, parkingType, parkingId, pType2, pType4, parkingVehicle, subVehicleNo, userTypeData, userType, barCode, printReceipt = "";
    ...
    private void findViews() {
        ...
        toolBar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent1 = new Intent(TwoWheeler.this, MainActivity.class);
        ...
        otp_VehicleNumber = (EditText) findViewById(R.id.otp_VehicleNumber);
        etvipInfo = (EditText) findViewById(R.id.etvipInfo);
        ...
        etMobileNo.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                if (etMobileNo.getText().toString().length() == 10)     //size as per your requirement
                {
                    ...
                    AppConstants.hideKeyboard(TwoWheeler.this, etMobileNo);
                }
            }
        ...
        etVehicleNumber.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                if (etVehicleNumber.getText().toString().length() == 4)     //size as per your requirement
                {
                    ...
                    AppConstants.hideKeyboard(TwoWheeler.this, etVehicleNumber);
                }
        ...
        otp_VehicleNumber.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                if (otp_VehicleNumber.getText().toString().length() == 4)     //size as per your requirement
                {
                    ...
                    AppConstants.hideKeyboard(TwoWheeler.this, otp_VehicleNumber);
                }
        ...
        vipVehicleNumber.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                if (vipVehicleNumber.getText().toString().length() == 10)     //size as per your requirement
                {
                    ...
                    AppConstants.hideKeyboard(TwoWheeler.this, vipVehicleNumber);
                }
            }
...
//                    etMobileNo.setVisibility(View.GONE);
    ...
    public void onClick(View v) {
        ...
        AppConstants.hideKeyboard(TwoWheeler.this, v);

        if (v == btnCheckIn) {
            validate();
        } else if (v == btnCheckout) {
            validate1();
        } else if (ContextCompat.checkSelfPermission(TwoWheeler.this, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
    ...
    private void moveToQrScan() {
        try {
            Intent qrintent = new Intent(TwoWheeler.this, QRScanPrint.class);
            qrintent.putExtra("userType", userType);
            qrintent.putExtra("Acticityclass", "TwoWheelerActivity");

            if (pType.length == 2) {
                qrintent.putExtra("Wheeler", getType);
            } else {
                qrintent.putExtra("Wheeler", getType);
            }
        ...
        if (userType.equals("VIP")) {
            if (AppConstants.isBlank(vipvehicleNumber)) {
                if (!etvipInfo.getText().toString().equals("")) {
                    ...
                    Toast.makeText(TwoWheeler.this, "Enter VIP Info", Toast.LENGTH_SHORT).show();
                }
                //  chechIn();
...
//                Toast.makeText(TwoWheeler.this, "Enter Vehicle number required", Toast.LENGTH_SHORT).show();
            ...
            if (userType.equals("Online")) {
                if (AppConstants.isBlank(otp_VehicleNumber.getText().toString())) {
                    ...
                    Toast.makeText(TwoWheeler.this, "Enter OTP required", Toast.LENGTH_SHORT).show();
                } else if (tagID.equals("")) {
                    Toast.makeText(this, "Please Scan card!", Toast.LENGTH_SHORT).show();
    ...
    public void chechIn() {
        if (AppConstants.isBlank(vehicleNumber)) {
            ...
            AppConstants.showToast(TwoWheeler.this, "Vehicle number should be 4 digit");
            etVehicleNumber.requestFocus();
        } else {
...
//                Toast.makeText(TwoWheeler.this, "Enter Vehicle number required", Toast.LENGTH_SHORT).show();
    ...
    private void apiCall() {
        ...
        if (AppConstants.isInternetAvailable(TwoWheeler.this)) {
            ...
            if (pType.length == 2) {
                ...
                parameterData.put(("parkingType"), "2Wheeler");
            ...
            Toast.makeText(TwoWheeler.this, "Internet Connection Required", Toast.LENGTH_LONG).show();
        }
    }
    ...
    public void vehicleCheckInServices(String url, final Map<String, String> params) {
        ...
        final ProgressDialog pDialog = new ProgressDialog(TwoWheeler.this);
            ...
            Response.ErrorListener errorListener = new Response.ErrorListener() {
                ...
                public void onErrorResponse(VolleyError volleyError) {
                    ...
                    if (volleyError instanceof NetworkError) {
                        ...
                        Toast.makeText(TwoWheeler.this,
                                "Oops. Network Error !",
            ...
            try {
                ...
                if (status == 0) {
                    ...
                    if (cardNo.equals("")) {
                        ...
                        tagID = "";
                        if (pType.length == 2) {
                            availableSlotSevice(parkingId, "2Wheeler", agentId);
                        } else {
                            availableSlotSevice(parkingId, "2Wheeler", agentId);
                        }
                ...
                Toast.makeText(TwoWheeler.this, "Unexpected Error...", Toast.LENGTH_SHORT).show();
                e.printStackTrace();
                // pDialog.dismiss();
            } catch (JSONException e) {
                e.printStackTrace();
                sendError(e.toString(), "parking/checkin?parkingId=");
                Toast.makeText(TwoWheeler.this, "Technical Error...", Toast.LENGTH_SHORT).show();
                // pDialog.dismiss();
            }
        }
    }
    ...
    private void apiCallCheckOut() {
        ...
        if (AppConstants.isInternetAvailable(TwoWheeler.this)) {
            //    String vehicleNo = StateCode + CityCode + VehicleCode + vehicleNumber;
            if (pType.length == 2) {
                vehicleCheckOut(parkingId, "2Wheeler", vehicleNo, agentId, userType, mobileNumber, tagID, vipinfo);
            } else {
    ...
    private void showAlert(String message) {
        AppConstants.showToast(TwoWheeler.this, message);
    }
...
*/
    ...
    public void availableSlotSevice(final String parkingId, final String parkingType, final String agentId) {
        ...
        String urlData = AppConstants.BASEURL + "parking/inventory?parkingId=" + parkingId + "&parkingType=" + "2Wheeler" + "&agentId=" + agentId;
        ...
        JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.GET, urlData, null, new Response.Listener<JSONObject>() {
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                // Toast.makeText(TwoWheeler.this, "Server Error...", Toast.LENGTH_SHORT).show();
...
//
                        ...
                        if (cardNo.equals("")) {
                            ...
                            Toast.makeText(TwoWheeler.this, message, Toast.LENGTH_LONG).show();
                            etStateCode.setText("");
                            etCityCode.setText("");
                            etVehicleCode.setText("");
                            etVehicleNumber.setText("");
...
//                            availableSlotSevice(parkingId, parkingType1234);
    ...
    private void printReceipt() {
        if (printer == null) {
            Toast.makeText(TwoWheeler.this, "No Printer found", Toast.LENGTH_SHORT).show();
            return;
        }
...
//                        showResultInfo("Print Exception", "Error", message);
        ...
        try {
            ...
            printNormal(TwoWheeler.this, printer);
...
//        if (printError.equals("yes")) {
    ...
    public void id(Intent intent) {
        ...
        AppConstants.setString(TwoWheeler.this, AppConstants.TAGID, tagID);
...
//cardNo=CARD578&parkingId=30&parkingType=2Wheeler
        String urlData = AppConstants.BASEURL + "parking/pass_detail_checkout?cardNo=" + tagID + "&parkingId=" + parkingId + "&parkingType=2Wheeler";
...
*/
                       ...
                       /* if (message1.equals("Card Not Exist !")) {
                            ...
                            Toast.makeText(TwoWheeler.this, message1, Toast.LENGTH_SHORT).show();
...
*/
    ...
    private void checkPermissions() {
        if (ContextCompat.checkSelfPermission(this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            ...
            startActivity(new Intent(TwoWheeler.this, MainActivity.class));
        }
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            case R.id.Paytm:
                ...
                Intent intent = new Intent(TwoWheeler.this, TransationActivity.class);
                if (pType.length == 2) {
