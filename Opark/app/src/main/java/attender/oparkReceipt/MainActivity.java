...
import attender.oparkReceipt.booking.CheckOutModel;
import attender.oparkReceipt.booking.FourWheeler;
import attender.oparkReceipt.booking.PatientVehicleWheeler;
import attender.oparkReceipt.booking.QRScanPrint;
import attender.oparkReceipt.booking.ReprintActivity;
import attender.oparkReceipt.booking.ThreeWheeler;
import attender.oparkReceipt.booking.TwoWheeler;
import attender.oparkReceipt.login.Login;
import attender.oparkReceipt.booking.CheckInModel;
import attender.oparkReceipt.apkservices.MyService;
import attender.oparkReceipt.parkinglist.model.GateList;
import attender.oparkReceipt.shiftreport.ShiftReportctivity;
import attender.oparkReceipt.subscription.activity.RemoveCardActivity;
import attender.oparkReceipt.subscription.activity.RenewCard;
import attender.oparkReceipt.subscription.activity.Subscription;
...
import attender.oparkReceipt.subscription.activity.Subscriptionctivity;
import attender.oparkReceipt.subscription.model.SubscriptionModelNew;
import attender.oparkReceipt.vehiclelist.activity.FourWheelerList;
import attender.oparkReceipt.vehiclelist.activity.LossReceipt;
import attender.oparkReceipt.vehiclelist.activity.PatientVehicleWheelerList;
import attender.oparkReceipt.vehiclelist.activity.ThreeWheelerList;
import attender.oparkReceipt.vehiclelist.activity.TwoWheelerList;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (parkingType.equals("2Wheeler,4Wheeler,3Wheeler,other")) {
            // navigationView.getMenu().findItem(R.id.nav_reprint).setVisible(false);
            navigationView.getMenu().findItem(R.id.nav_remove).setVisible(true);
            // navigationView.getMenu().findItem(R.id.nav_gate).setVisible(true);
            navigationView.getMenu().findItem(R.id.nav_twowheeler).setVisible(false);
            //   navigationView.getMenu().findItem(R.id.nav_PatientVehicle).setVisible(false);
        ...
        if (parkingType.equals("2Wheeler,4Wheeler,3Wheeler")) {
            //navigationView.getMenu().findItem(R.id.nav_reprint).setVisible(true);
            navigationView.getMenu().findItem(R.id.nav_remove).setVisible(true);
            // navigationView.getMenu().findItem(R.id.nav_gate).setVisible(true);
            navigationView.getMenu().findItem(R.id.nav_twowheeler).setVisible(false);
            navigationView.getMenu().findItem(R.id.nav_threewheeler).setVisible(false);
            ...
            navigationView.getMenu().findItem(R.id.nav_carInActivityThree).setVisible(true);
            //  navigationView.getMenu().findItem(R.id.nav_PatientVehicle).setVisible(false);
            // navigationView.getMenu().findItem(R.id.nav_PatientVehicle_List).setVisible(false);
        ...
        if (parkingType.equals("4Wheeler")) {
            ...
            navigationView.getMenu().findItem(R.id.towvhicle).setVisible(false);
            //  navigationView.getMenu().findItem(R.id.nav_PatientVehicle).setVisible(false);
            // navigationView.getMenu().findItem(R.id.nav_PatientVehicle_List).setVisible(false);// navigationView.getMenu().findItem(R.id.nav_logout).setVisible(false);
        }
...
*/
        ...
        if (AppConstants.isInternetAvailable(MainActivity.this)) {
            ...
            btnCheckout.setBackground(getResources().getDrawable(R.drawable.gradient));
            btnScanQRCode.setBackground(getResources().getDrawable(R.drawable.sacngradient));
            ...
            btnScanQRCode.setClickable(false);
            ...
            btnScanQRCode.setBackground(getResources().getDrawable(R.drawable.buttongradient_gray));
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                ...
                switch (menuItem.getItemId()) {
                    ...
                    case R.id.nav_twowheeler:
                        intent = new Intent(MainActivity.this, TwoWheeler.class);
                        ...
                        radioGate.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
                            ...
                            public void onCheckedChanged(RadioGroup group, int checkedId) {
                                ...
                                if (checkedId == R.id.Gate1) {
                                    ...
                                    Toast.makeText(MainActivity.this, "Please Select Gate No", Toast.LENGTH_SHORT).show();
                                }
                            }
                        });
                        ...
                        btnSubmit.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                if (sharedpref.getString("VehicleType1", "").equals("")) {
                                    ...
                                    Toast.makeText(MainActivity.this, "Please select Gate ", Toast.LENGTH_SHORT).show();
                    ...
                    case R.id.nav_PatientVehicle:
                        intent = new Intent(MainActivity.this, PatientVehicleWheeler.class);
                        intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK | IntentCompat.FLAG_ACTIVITY_CLEAR_TASK);
                        startActivity(intent);
                        overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
                  ...
                  /*  case R.id.nav_reprint:
                    ...
                    case R.id.nav_threewheeler:
                        intent = new Intent(MainActivity.this, ThreeWheeler.class);
                        intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK | IntentCompat.FLAG_ACTIVITY_CLEAR_TASK);
                        startActivity(intent);
                        overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
                    ...
                    case R.id.nav_fourwheeler:
                        intent = new Intent(MainActivity.this, FourWheeler.class);
                        intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK | IntentCompat.FLAG_ACTIVITY_CLEAR_TASK);
                        startActivity(intent);
                        overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
...
//                        intentLossReceipt.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK|IntentCompat.FLAG_ACTIVITY_CLEAR_TASK)
                    case R.id.nav_LossReceipt:
                        intent = new Intent(MainActivity.this, LossReceipt.class);
                    ...
                    case R.id.nav_shiftreport:
                        ...
                        intent = new Intent(MainActivity.this, ShiftReportctivity.class);
                        startActivity(intent);
                        overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
                        return true;
                    case R.id.nav_carInActivityTwo:
                        intent = new Intent(MainActivity.this, TwoWheelerList.class);
                        startActivity(intent);
                        overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
                        return true;
                    ...
                    case R.id.nav_renew:
                        intent = new Intent(MainActivity.this, RenewCard.class);
                        startActivity(intent);
                        overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
                        return true;
                    case R.id.nav_remove:
                        intent = new Intent(MainActivity.this, RemoveCardActivity.class);
                        startActivity(intent);
                        overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
                        return true;

                    case R.id.nav_detail:
                        intent = new Intent(MainActivity.this, Subscriptionctivity.class);
                        startActivity(intent);
                        overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
                        return true;
...
*/
                    ...
                    Toast.makeText(MainActivity.this, "Enter VIP Info", Toast.LENGTH_SHORT).show();
            ...
            try {
                ...
                if (status == 0) {
                  ...
                  /*  etStateCode.setEnabled(false);
                    ...
                    btnCheckIn.setBackground(getResources().getDrawable(R.drawable.buttongradient_gray));
                    btnCheckout.setBackground(getResources().getDrawable(R.drawable.buttongradient_gray));*//* etStateCode.setFocusable(false);
                ...
                try {
                     ...
                     */   // etStateCode.setFocusable(false);
                        ...
                        if (getprintReceipt.equals("no")) {
                            ...
                            availableSlotSevice(parkingId, parkingType12, MainActivity.this.agentId);
...
*/
            ...
            if (AppConstants.isNetworkAvailable(MainActivity.this)) {
