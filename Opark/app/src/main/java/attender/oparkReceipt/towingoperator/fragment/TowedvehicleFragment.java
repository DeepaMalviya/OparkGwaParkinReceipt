...
import attender.oparkReceipt.towingoperator.adapter.TowAdapter;
 ...
 * {@link TowedvehicleFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link TowedvehicleFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class TowedvehicleFragment extends Fragment {
    // TODO: Rename parameter arguments, choose names that match
    // the fragment initialization parameters, e.g. ARG_ITEM_NUMBER
    private static final String ARG_PARAM1 = "param1";
    private static final String ARG_PARAM2 = "param2";
    public static final String TAG = "TowedvehicleFragment";

    // TODO: Rename and change types of parameters
    private String mParam1;
    private String mParam2;

    TowAdapter towAdapter;
    ...
    String agentId, vendorId;

    private OnFragmentInteractionListener mListener;

    public TowedvehicleFragment() {
     ...
     * @return A new instance of fragment TowedvehicleFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static TowedvehicleFragment newInstance(String param1, String param2) {
        TowedvehicleFragment fragment = new TowedvehicleFragment();
...
//    }
    ...
    public void getDetails(String vendorId) {
        ...
        /*http://staggingapi.opark.in/index.php/v1/towing/towvehicle_list?operatorId=8*/
        String urlData = AppConstants.BASEURL + "towing/towvehicle_list?vendorId=" + vendorId;
            ...
            public void onResponse(JSONObject json) {
                ...
                try {
                    ...
                    if (status == 0) {
                        ...
                        recyclerViewVehicle.setAdapter(towAdapter);
